...
QUARTERLY_REPORT_YEAR,
QUARTERLY_REPORT_QUARTER
)
...
from market_memory_engine.templates.quarterly_template import generate_multi_asset_quarterly_report
...
if __name__ == "__main__":
    ...
    q2 = recall.recall_quarter(QUARTERLY_REPORT_YEAR, QUARTERLY_REPORT_QUARTER)
    op_file = get_output_file_name_path(

        timeframe="QUARTERLY",

        year=QUARTERLY_REPORT_YEAR,

        quarter=QUARTERLY_REPORT_QUARTER

    )
    generate_multi_asset_quarterly_report(universe(q2), str(op_file))