...
def plot_paths(paths, n_plot=50, save_path=None):
...
def plot_with_bands(paths, save_path=None):
...
def plot_distribution(paths, save_path=None):
...
def plot_probability_curve(paths, level, save_path=None):
...
def plot_time_to_hit(paths, level, save_path=None):
